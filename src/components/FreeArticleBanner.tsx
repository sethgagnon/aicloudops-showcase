...
const FreeArticleBanner = () => {
  ...
  if (guestArticlesUsed === 0) {
    return <div className="bg-gradient-to-r from-accent/10 to-primary/10 border-b border-accent/20">
  ...
  if (canReadFreeArticle()) {
    return <div className="bg-gradient-to-r from-primary/10 to-accent/10 border-b border-primary/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
  ...
  return <div className="bg-gradient-to-r from-primary to-accent text-white">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <p className="text-sm">
              ...
              <span className="ml-1 opacity-90">Sign up to continue reading - it's free.</span>
            </p>
          </div>
          <Link to="/auth">
